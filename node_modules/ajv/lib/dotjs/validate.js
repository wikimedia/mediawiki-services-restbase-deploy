              ...
              if ($rule.custom) {
                ...
                if ($inline) {
                  if ($rDef.errors) {
                    ...
                    out += ' } ';
                  } else if ($rDef.errors === false) {
                    if (!it.compositeRule && $breakOnError) {
                      out += ' validate.errors = [ '; /* istanbul ignore else */
                      if (it.createErrors !== false) {
                        out += ' { keyword: \'' + ('custom') + '\' , dataPath: (dataPath || \'\') + ' + (it.errorPath) + ' , schemaPath: "' + ($schemaPath) + '" , params: { keyword: \'' + ($rule.keyword) + '\' } ';
        ...
        if ($rulesGroup.type) {
          ...
          if ($typeSchema && $typeSchema === $rulesGroup.type) {
            ...
            if (!it.compositeRule && $breakOnError) {
              out += ' validate.errors = [ '; /* istanbul ignore else */
              if (it.createErrors !== false) {
                out += ' { keyword: \'' + ('type') + '\' , dataPath: (dataPath || \'\') + ' + (it.errorPath) + ' , schemaPath: "' + ($schemaPath) + '" , params: { type: \'';
                if ($isArray) {
                  out += '' + ($typeSchema.join(","));
                } else {
                  out += '' + ($typeSchema);
